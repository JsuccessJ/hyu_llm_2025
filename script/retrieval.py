...
class Neo4jRetrieval:
    ...
    def extract_keywords(self, text: str) -> List[str]:
        # 불용어 리스트 정의
        stopwords = ['이', '그', '저', '것', '수', '등', '및', '또는', '그리고', '하지만', '그래서','때문에', '위해', '대해', '관련', '따라서', '그러나', '그리고', '또한', '그래도','이런', '저런', '그런', '이러한', '저러한', '그러한', '이런', '저런', '그런','이것', '저것', '그것', '이런', '저런', '그런', '이렇게', '저렇게', '그렇게', '추천','하다','해주다','나', '용이','어울리다','알다', '뭐', '좋다', '향수','계열','향']
